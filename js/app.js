/* ============ データ ============ */
const VERSIONS = [
 {v:"1.1.0",d:"2022-09-08",t:"patch",n:"発売前日の初回更新。ヒーローモードの機能追加・通信機能の有効化（ブキ調整なし）"},
 {v:"1.1.1",d:"2022-09-16",t:"patch",n:"不具合修正"},
 {v:"1.1.2",d:"2022-09-30",t:"patch",n:"不具合修正"},
 {v:"1.2.0",d:"2022-10-26",t:"balance",n:"サブ（タンサンボム）とスペシャル必要ポイントを初調整。メインブキの性能調整は次回以降"},
 ...
 {v:"3.1.0",d:"2023-03-31",t:"balance",n:"バランス調整。ノヴァ・バケツ・LACT-450など9ブキを強化、カニタンクを弱体"},
 ...
 {v:"4.1.0",d:"2023-07-27",t:"balance",n:"バランス調整。スシ・N-ZAP・ノヴァなど10ブキを強化"},
 {v:"5.0.0",d:"2023-08-31",t:"major",n:"2023秋 Drizzle Season 開幕。モップリン・イグザミナー追加、シェルター系を強化"},
 {v:"5.0.1",d:"2023-09-15",t:"patch",n:"不具合修正"},
 {v:"5.1.0",d:"2023-10-18",t:"balance",n:"バランス調整。わかば・L3・H3・ハイドラントなど10ブキを強化"},
 {v:"5.2.0",d:"2023-11-16",t:"patch",n:"ブキ調整なし。amiibo対応・タイカイサポート等の更新（ブキ調整は次回シーズンへ）"},
 ...
 {v:"6.1.0",d:"2024-01-25",t:"balance",n:"バランス調整。ダイナモ・スパイガジェット等を強化、ボトル・クーゲル・ジムを弱体"},
 {v:"7.0.0",d:"2024-02-22",t:"major",n:"2024春 Fresh Season 開幕"},
 {v:"7.1.0",d:"2024-03-22",t:"patch",n:"ブキ調整なし。フェス楽曲の追加と不具合修正が中心"},
 {v:"7.2.0",d:"2024-04-18",t:"balance",n:"バランス調整。ボールド・ノヴァなど8ブキを強化、SP必要ポイントを多数調整"},
 {v:"8.0.0",d:"2024-05-31",t:"major",n:"2024夏 Sizzle Season 開幕"},
 {v:"8.1.0",d:"2024-07-18",t:"balance",n:"バランス調整。ブラスター・ローラー中心に11ブキを強化"},
 {v:"9.0.0",d:"2024-08-30",t:"major",n:"2024秋 Drizzle Season 開幕（最終シーズン）"},
 {v:"9.1.0",d:"2024-09-12",t:"patch",n:"ブキ調整なし。グランドフェスティバル向けデータ追加が中心"},
 {v:"9.2.0",d:"2024-11-21",t:"balance",n:"バランス調整。スシ・プライム・リールガン系など9ブキを強化"},
 {v:"9.3.0",d:"2025-03-13",t:"balance",n:"バランス調整。14ブキを調整。多数を強化し、R-PEN・デンタルワイパーを弱体"},
 {v:"10.0.0",d:"2025-06-12",t:"major",n:"大型更新。新ブキ約30種追加・新ステージ・Nintendo Switch 2対応"},
 {v:"10.0.1",d:"2025-06-27",t:"patch",n:"不具合修正"},
 {v:"10.1.0",d:"2025-09-04",t:"balance",n:"バランス調整。シャープ・.52ガロンをリワーク、SP必要ポイントを大幅見直し"},
 {v:"11.0.0",d:"2026-01-29",t:"major",n:"大型更新。多数のブキを再調整（バレル・スプラローラー等を強化、S-BLAST弱体）。「イカ流」や相手の体力表示を追加"},
 {v:"11.0.1",d:"2026-02-05",t:"balance",n:"ブキ調整あり。ラピッドブラスター強化／Rブラスターエリート弱体"},
...
const TYPE_LABEL = {major:"シーズン・大型", balance:"バランス調整", patch:"不具合・その他"};
...
new Chart(document.getElementById("chartType"),{
  type:"doughnut",
  data:{labels:["シーズン・大型","バランス調整","不具合・その他"],datasets:[{
